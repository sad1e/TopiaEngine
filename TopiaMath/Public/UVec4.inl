namespace topia
{
	UVec4::UVec4(u32 inX, u32 inY, u32 inZ, u32 inW)
	{
...
#error Unsupported CPU architecture
	...
	UVec4 UVec4::sReplicate(u32 inV)
	{
#if defined(TOPIA_USE_SSE)
...
#error Unsupported CPU architecture
	...
	UVec4 UVec4::sLoadInt(const u32 *inV)
	{
#if defined(TOPIA_USE_SSE)
...
#error Unsupported CPU architecture
	...
	UVec4 UVec4::sLoadInt4(const u32 *inV)
	{
#if defined(TOPIA_USE_SSE)
...
#error Unsupported CPU architecture
	...
	UVec4 UVec4::sLoadInt4Aligned(const u32 *inV)
	{
#if defined(TOPIA_USE_SSE)
...
#error Unsupported CPU architecture
	...
	UVec4 UVec4::sGatherInt4(const u32 *inBase, UVec4Arg inOffsets)
	{
...
#error Unsupported CPU architecture
	...
	void UVec4::StoreInt4(u32 *outV) const
	{
#if defined(TOPIA_USE_SSE)
...
#error Unsupported CPU architecture
	...
	void UVec4::StoreInt4Aligned(u32 *outV) const
	{
#if defined(TOPIA_USE_SSE)
