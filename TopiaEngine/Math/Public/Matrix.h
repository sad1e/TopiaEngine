...
namespace topia
{
	...
	/**
	 * Templatized and column-first matrix class.
	 */
	template <uint Rows, uint Cols>
	class TOPIA_NODISCARD Matrix
	{
	public:
		/// Constructor
		...
		inline static const Matrix sZero()
		{
			Matrix m;
			m.SetZero();
			return m;
		...
		inline static const Matrix sIdentity()
		{
			Matrix m;
			m.SetIdentity();
			return m;
